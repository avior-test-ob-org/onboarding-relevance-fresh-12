...
SERVICE_NAME = "onboarding-relevance-fresh-12"
PEERS: tuple[Peer, ...] = (
    Peer("avior-test-ob-org/onboarding-relevance-fresh-13", "FRESH_13_URL"),
    Peer("avior-test-ob-org/onboarding-relevance-fresh-14", "FRESH_14_URL"),
)
